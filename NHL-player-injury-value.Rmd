...
Figure 1 presents the relationship between Team WAR and Team Points Percentage, as discussed in the introduction. The two variables were strongly correlated (Adjusted R-squared: 0.6467), suggesting that there is a relationship between team strength, in terms of WAR, and team performance.
...
last_war_lost_plot <- team_performance_change_df %>%
  ...
  theme(axis.title = element_text(),
        axis.title.y = element_text(margin = margin(r = 10)),
        axis.title.x = element_text(margin = margin(t = 10))) +
  labs(x = "Team WAR Lost, Season n-1", y = "Team WAR Lost, Season n") 

print(last_war_lost_plot)
```

Robust regression is an alternative to least squares regression when data are contaminated with outliers or influential observations, and it can also be used for the purpose of detecting influential observations. In instances where we're evaluating the relationship between Team WAR lost and another variable, PIT 2011-2012, PIT 2010-2011, and MTL 2015-2016 are outliers, and are possibly problematic to an ordinary least squares model. In this case, robust regression is a suitable method.
...
war_lost_change_plot <- player_injury_change_df %>%
  ...
  theme(axis.title = element_text(),
        axis.title.y = element_text(margin = margin(r = 10)),
        axis.title.x = element_text(margin = margin(t = 10))) +
  labs(x = "Player WAR Lost, Season n-1", y = "Player WAR Lost, Season n") 
...
Figure 7 presents the relationship between. Interestingly, there does not appear to be a strong relationship between the change value lost to injury, and team points percentage.
...
Table 1 presents the top twenty player-seasons in terms of WAR lost to injury. Sidney Crosby, having missed the majority of his age 23 and age 24 seasons due to concussion issues. Carey Price, Steven Stamkos.

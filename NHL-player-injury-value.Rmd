...
Younggren and Younggren's version of WAR was also considered, and is superior in several ways; it encompasses regular season results exclusively, and its formatting conventions would have made analysis easier. However, Younggren and Younggren's WAR is meant to be descriptive of a player's performance in a single season, whereas Perry's emphasizes predictivity and better approximates true player talent. As such, Perry's version of WAR was the preferred option for this analysis.
...
Players who were injured but didn't have a WAR record were then filtered. Manny's cut-off for WAR was x number of events. Players were manually examined to determine that there weren't any formatting issues.

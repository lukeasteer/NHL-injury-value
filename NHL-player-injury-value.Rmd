...
player_injury_change_df <- player_injury_value_df %>%
  select(first_name, last_name, season, position = position_new, war_lost) %>%
   # Account for players who were traded
...
```{r warning=FALSE, message=FALSE, results='asis', fig.align='center'}

...
war82_df <- war_df %>%
  ...
  select(player = Player, season = Season, team = Team, games_played = GP, toi = TOI, war = WAR, war_82 = `WAR/82`, war_60 = `WAR/60`) %>%
...
# Determineteam WAR totals for analysis of relationship between team WAR and points percentage, as referenced in introduction
team_war_relationship <- war82_df %>%
  select(team = team_one, season, war) %>%
  group_by(team, season) %>%
...
#
team_war_relationship_model <- rlm(points_pct ~ team_war, team_war_relationship)
...
team_war_relationship_plot <- team_war_relationship %>%
  ...
  stat_smooth(method = function(formula, data, weights = weight) rlm(formula,
                                                                 ...
                                                                 method = "MM"),
              fullrange = TRUE) +
  labs(title = "Team WAR vs. Points Percentage")

team_war_relationship_plot <- team_war_relationship_plot + theme_fivethirtyeight() + scale_colour_fivethirtyeight()
...
```{r warning=FALSE, message=FALSE, fig.align='center'}
mgl_lost_relationship_model <- rlm(points_pct_change ~ team_mgl_change, team_performance_change_df, method = "MM")

mgl_relationship_lost_plot <- team_performance_change_df %>%
  ...
  stat_smooth(method = function(formula, data, weights = weight) rlm(formula,
                                                                 ...
                                                                 method = "MM"),
              fullrange = TRUE) +
  labs(title = "Change in Team MGL vs. Change In Points Percentage")

mgl_lost_relationship_plot <- mgl_relationship_lost_plot + theme_fivethirtyeight() + scale_colour_fivethirtyeight()
...
```{r warning=FALSE, message=FALSE, fig.align='center'}
chip_lost_relationship_model <- rlm(points_pct_change ~ team_chip_change, team_performance_change_df, method = "MM")

chip_relationship_lost_plot <- team_performance_change_df %>%
  ...
  stat_smooth(method = function(formula, data, weights = weight) rlm(formula,
                                                                 ...
                                                                 method = "MM"),
              fullrange = TRUE) +
  labs(title = "Change in Team CHIP vs. Change In Points Percentage")

chip_relationship_lost_plot <- chip_relationship_lost_plot + theme_fivethirtyeight() + scale_colour_fivethirtyeight()

print(chip_relationship_lost_plot)
summary(chip_lost_relationship_model)
```

```{r warning=FALSE, message=FALSE, fig.align='center'}
war_lost_relationship_model <- rlm(points_pct_change ~ team_war_change, team_performance_change_df, method = "MM")

war_relationship_lost_plot <- team_performance_change_df %>%
  ...
  stat_smooth(method = function(formula, data, weights = weight) rlm(formula,
                                                                 ...
                                                                 method = "MM"),
              fullrange = TRUE) +
  labs(title = "Change in Team WAR vs. Change In Points Percentage")

war_relationship_lost_plot <- war_relationship_lost_plot + theme_fivethirtyeight() + scale_colour_fivethirtyeight()

print(war_relationship_lost_plot)

...
team_war_relationship_plot <- team_war_relationship %>%
  ...
  ggtitle("Team WAR vs. Points Percentage") +
...
mgl_lost_relationship_plot <- team_performance_change_df %>%
  ...
  theme_fivethirtyeight() +
  scale_colour_fivethirtyeight() +
  theme(axis.title = element_text()) + labs(x = "Change in Team MGL", y = "Change in Points Percentage") +
  theme(axis.title.y = element_text(margin = margin(r = 10))) +
  theme(axis.title.x = element_text(margin = margin(t = 10)))
...
chip_lost_relationship_plot <- team_performance_change_df %>%
  ...
  theme_fivethirtyeight() +
  scale_colour_fivethirtyeight() +
  theme(axis.title = element_text()) + labs(x = "Change in Team CHIP", y = "Change in Points Percentage") +
  theme(axis.title.y = element_text(margin = margin(r = 10))) +
  theme(axis.title.x = element_text(margin = margin(t = 10)))
...
war_lost_relationship_plot <- team_performance_change_df %>%
  ...
  theme_fivethirtyeight() +
  scale_colour_fivethirtyeight() +
  theme(axis.title = element_text()) + labs(x = "Change in Team WAR Lost", y = "Change in Points Percentage") +
  theme(axis.title.y = element_text(margin = margin(r = 10))) +
  theme(axis.title.x = element_text(margin = margin(t = 10)))
